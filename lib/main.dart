...
class TimelinePageState extends State<TimelinePage> {
  List<HistoryEntry> historyEntries; String someValue = ''; double itemSize = 180; int rowOffset = 3;
  ...
  Widget build(BuildContext context) {
    return Scaffold(body: historyEntries != null ? Stack(
        children: <Widget>[
          Center(child: Column(mainAxisAlignment: MainAxisAlignment.center, children: <Widget>[ Opacity(opacity: 0.1,child: Image.asset('assets/us_map.png', width: 200, height: 150)),Text(someValue, style:TextStyle(fontFamily: 'TraditioAh', color: Colors.grey.withOpacity(0.5), fontSize: 70))])),
          Container(margin: EdgeInsets.only(left: 37),color: Colors.grey.withOpacity(0.5),width: 1),
          Container(child: NotificationListener(child: ListView.builder(controller: _scrollController, itemExtent: 180,
